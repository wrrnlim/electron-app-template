...
![status](https://img.shields.io/badge/Status-Complete-green) ![Electron version](https://img.shields.io/badge/electron-v13.5.1-blue) ![GitHub Release Date](https://img.shields.io/github/release-date/wrrnlim/electron-app-template) 
